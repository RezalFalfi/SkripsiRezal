    ...
    <div class="wrapper">
        <header class="main-header">
            <a href="<?php echo base_url('beranda'); ?>" class="logo">
                ...
                <span class="logo-lg"><img src="<?php echo base_url('assets/images/logo-Lambeugak.png'); ?>" width="27"
                        alt="SIMPENDUK"><b>LAMBEUGAK</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <b><?php echo $this->session->userdata('nama_petugas'); ?></b> 
                            </a>
