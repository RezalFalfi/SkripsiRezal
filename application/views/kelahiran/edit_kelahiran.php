                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <select name="hari" class="form-control" required>
                                            <option value="Senin" <?php if ($kelahiran->hari == "1") echo "selected"; ?>>
                                                Senin
                                            </option>
                                            <option value="Selasa" <?php if ($kelahiran->hari == "2") echo "selected"; ?>>
                                                Selasa
                                            </option>
                                            <option value="Rabu" <?php if ($kelahiran->hari == "3") echo "selected"; ?>>
                                                Rabu
                                            </option>
                                            <option value="Kamis" <?php if ($kelahiran->hari == "4") echo "selected"; ?>>
                                                Kamis
                                            </option>
                                            <option value="Jumat" <?php if ($kelahiran->hari == "5") echo "selected"; ?>>
                                                Jumat
                                            </option>
                                            <option value="Sabtu" <?php if ($kelahiran->hari == "6") echo "selected"; ?>>
                                                Sabtu
                                            </option>
                                            <option value="Minggu" <?php if ($kelahiran->hari == "7") echo "selected"; ?>>
                                                Minggu
                                            </option>
                                        </select>
                                    </div>
