    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header">
                <h4 style="text-align:center">  <b style="line-height:25px">EDIT DATA KEMATIAN <br></b>
                </h4>
                <hr>
            </div>
            ...
            <div class="box-body">
                ...
                <form action="<?php echo base_url('kematian/proses_edit'); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <label>NIK</label>
                        <input type="text" name="id" value="<?php echo $kematian->nik; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo base_url('kematian/tampil_kematian'); ?>"
