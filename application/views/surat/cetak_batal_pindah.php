...
<br />
<font align="justify">
Menurut penilitian kami dan surat pengantar dari RT-nya bahwa Nama/Orang tersebut benar Warga Desa Lambeugak, dan bertempat tinggal dialamat tersebut diatas. Menerangkan bahwa yang bersangkutan diatas benar batal Pindah ke alamat di bawah ini;<br />
</font>
...
<table width="100%">
	<tr>
		<td width="50%"></td>
		<td width="50%"><center>Lambeugak, <?=date('d F Y', strtotime($batal_pindah->tanggal_batal_pindah));?></center></td>
	</tr>
	<tr>
		<td><center></center></td>
		<td><center>Kepala Desa Lambeugak</center></td>
	</tr>
	<tr>
		<td></td>
		<td><center>Kecamatan Kuta Cot Gile</center></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
