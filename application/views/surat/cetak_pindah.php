...
<table width="100%">
	<tr>
		<td width="50%"></td>
		<td width="50%"><center>Lambeugak, <?php echo $pindah->tanggal_pindah; ?></center></td>
	</tr>
	<tr>
		<td></td>
		<td><center>Dikeluarkan oleh: <br />a.n. Kepala Dinas Kependudukan dan Pencatatan Sipil<br />Kepala Desa Lambeugak</center></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
