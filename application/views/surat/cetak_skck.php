...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $skck->jabatan_pejabat; ?> Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar Provinsi Aceh
</font>
<table width="100%">
    <tr>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Lambeugak, <?= date('d F Y', strtotime($skck->tanggal_skck)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
