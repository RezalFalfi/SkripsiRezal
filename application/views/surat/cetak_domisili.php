...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , Kepala Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh Besar menerangkan :
</font>
<table width="100%">
    <tr>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Lambeugak, <?= date('d F Y', strtotime($domisili->tanggal_domisili)); ?> </center>
        </td>
    </tr>
    <tr>
        <td>
