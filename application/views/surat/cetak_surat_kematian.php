...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $surat_kematian->jabatan_pejabat; ?> Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar, menerangkan bahwa pada:
</font>
<table width="100%">
    <tr>
        <td width="20%">Nama</td>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Lambeugak, <?= date('d F Y', strtotime($surat_kematian->tanggal_surat_kematian)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
