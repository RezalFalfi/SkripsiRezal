...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $haji->jabatan_pejabat; ?> Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar Provinsi Aceh menerangkan bahwa:
</font>
<table width="100%">
    <tr>
...
<br />
<font align="justify">
    Nama tersebut diatas benar Warga Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar Provinsi Aceh .
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Lambeugak, <?= date('d F Y', strtotime($haji->tanggal_haji)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
