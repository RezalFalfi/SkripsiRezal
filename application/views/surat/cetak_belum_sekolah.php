...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , Kepala Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar Provinsi Aceh
</font>
<table width="100%">
    <tr>
...
<br /><br />
<font align="justify">
    Nama / Orang tersebut benar Warga Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar, Menerangkan dengan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Lambeugak, <?= date('d F Y', strtotime($belum_sekolah->tanggal_belum_sekolah)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td>
            <center>Kecamatan Kuta Cot Gile</center>
        </td>
    </tr>
    <tr>
        <td></td>
