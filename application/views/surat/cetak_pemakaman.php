...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , Kepala Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar Provinsi Aceh, Menerangkan bahwa
</font>
<table width="100%">
    <tr>
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Lambeugak, <?= date('d F Y', strtotime($pemakaman->tanggal_pemakaman)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
