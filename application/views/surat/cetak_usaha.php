...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , <?php echo $usaha->jabatan_pejabat; ?> Desa Lambeugak Kecamatan Kuta Cot Gile Kabupaten Aceh besar Provinsi Aceh
</font>
<table width="100%">
    <tr>
...
<br>
<font align="justify">
    Menurut penelitian dan Pengantar RT setempat Nama/Orang tersebut benar Warga Desa Lambeugak KKecamatan Kuta Cot Gile Kabupaten Aceh besar, bahwa yang bersangkutan benar Membuka / Mempunyai Usaha
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Lambeugak, <?= date('d F Y', strtotime($usaha->tanggal_usaha)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <center>Kepala Desa Lambeugak</center>
        </td>
    </tr>
    <tr>
        <td></td>
