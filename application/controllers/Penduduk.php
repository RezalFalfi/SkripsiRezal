...
class Penduduk extends CI_Controller {
	...
	public function tampil() {
		$data['title'] = "Data Penduduk - Desa Lambeugak";
	...
	public function tambah() {
		$data['title'] = "Tambah Penduduk - Desa Lambeugak";
	...
	public function edit($nik) {
		$data['title'] = "Edit penduduk - Desa Lambeugak";
	...
	public function detail($nik) {
		...
		$data['title'] = "Detail penduduk - Desa Lambeugak";
		$this->load->model('m_penduduk');
