...
class Pindah extends CI_Controller
{
	...
	{
		$data['title'] = "Data Pindah  - Desa Lambeugak";
	...
	{
		$data['title'] = "Tambah Pindah  - Desa Lambeugak";
	...
	{
		$data['title'] = "Edit Pindah  - Desa Lambeugak";
	...
	public function detail($nik)
	{
		...
		$data['title'] = "Detail Pindah  - Desa Lambeugak";
		$this->load->model('m_pindah');
